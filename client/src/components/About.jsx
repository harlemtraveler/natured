...
function About (props) {
  ...
  <div className="flex-container">
    ...
    solutions to the environmental crisis</p>
      ...
      to allow customers to sell their gear to us. We offer very competitive rates to buy your lightly used equipment. Create a profile <a href="/register">here</a> to get started.
      <br/>
      <br/>
